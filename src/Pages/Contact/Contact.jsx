...
const Contact = () => {
    return (
        <>
            <section className="relative z-10 overflow-hidden bg-white py-8 dark:bg-dark lg:py-[30px]">
                    ...
                    <div className="-mx-4 flex flex-wrap lg:justify-between">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <h2 className="mb-3 text-[32px] font-bold uppercase text-dark dark:text-white sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                                    GET IN TOUCH WITH US
                                </h2>
                                <p className="mb-9 text-lg text-[var(--primary-color)] leading-relaxed text-body-color dark:text-dark-6">
                                Connect with us for compassionate care. Your health is our priority. Get in touch for expert medical assistance and support.
                                </p>
            ...
            <circle cx="2.66536" cy="1.66665" r="1.66667" transform="rotate(180 2.66536 1.66665)" fill="#13C296"
                                    ...
                                    <span className="absolute -bottom-7 -left-7 z-[-1]"> <svg width={107} height={134} viewBox="0 0 107 134" fill="none" xmlns="http://www.w3.org/2000/svg" >
